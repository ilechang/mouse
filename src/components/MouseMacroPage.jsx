...
export default function MouseProfile({ hoveredProfile, committedProfile }) {
  ...
  return (
    ...
    >
      <h1 className="display-6 fw-bold mb-3 mt-5">
        Software/game specific profile
      </h1>
      <p className="text-white text-center mb-4" style={{ maxWidth: "1000px" }}>
        Whether you’re working or gaming, create tailored profiles with custom
        keys and shortcuts — boosting productivity and delivering an immersive
        experience that’s uniquely yours.
      </p>
          ...
          return (
            <button
              ...
              style={{
                ...
                boxShadow: isActive ? "0 0 30px rgba(0, 123, 255)" : "none",
