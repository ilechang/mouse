...
export default function PhysicalFeatures() {
  ...
  const desktopStyle = {
    ...
    backgroundAttachment: "fixed", // ✅ 桌機視差效果
  };
  ...
  return (
    <div
      ...
      className="physical-features-section"
    >
      ...
      >
        ...
        >
          <div style={{ flex: "0 0 auto", textAlign: "center" }}>
            <img
              src="/vent.webp"
              alt="Dual-Layer Design"
              style={{ width: "550px", maxWidth: "90vw", height: "auto" }}
            />
          </div>
          <div style={{ flex: "0 0 auto", textAlign: "center" }}>
            <img
              src="/grip.webp"
              alt="Wrist & Forepalm Support"
              style={{ width: "300px", maxWidth: "60vw", height: "auto" }}
            />
          </div>
        </div>

        <h1 className="display-6 fw-bold mb-3 mt-4 text-center mx-auto text-white">
